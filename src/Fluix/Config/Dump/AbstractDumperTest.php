...
abstract class AbstractDumperTest extends TestCase
{
    ...
    abstract public function supportProvider(): array;
    abstract public function dumpProvider(): array;
    
    /**
     * @dataProvider supportProvider
     */
    final public function testSupports(string $format, bool $expected): void
    {
        self::assertEquals($expected, $this->dumper->supports(Format::fromString($format)));
    }
    ...
    protected function setUp(): void
    {
        ...
        $this->content = vfsStream::newFile($this->basename())->at(vfsStream::setup());
